package edu.northeastern.csye6220.eKartFinalProject.util;
	    ...
	    public static SessionFactory getSessionFactory() {
	        if (sessionFactory == null) {
	            try {
	                ...
	                settings.put(Environment.URL, "jdbc:mysql://localhost:3306/eKartStore12?createDatabaseIfNotExist=true");
